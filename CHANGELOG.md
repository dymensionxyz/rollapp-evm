...
* **ante:** support gas free authz msgs ([#506](https://github.com/dymensionxyz/rollapp-evm/issues/506)) ([d9baabe](https://github.com/dymensionxyz/rollapp-evm/commit/d9baabebd94058963b12eb47554d89e75d91ecfe))
...
* **deps:** now ibc genesis tx is free ([#462](https://github.com/dymensionxyz/rollapp-evm/issues/462)) ([4a29964](https://github.com/dymensionxyz/rollapp-evm/commit/4a29964362f1986497453f886db456c9cf338106))
...
* **DRS:** add missing drs7 upgrade to the upgrades list ([#495](https://github.com/dymensionxyz/rollapp-evm/issues/495)) ([8017532](https://github.com/dymensionxyz/rollapp-evm/commit/8017532d12043010847dff458b384aa7057e9556))
...
* **ERC20:** convertion on IBC transfer with vesting account ([#494](https://github.com/dymensionxyz/rollapp-evm/issues/494)) ([5638d7e](https://github.com/dymensionxyz/rollapp-evm/commit/5638d7e8ac4d1987b50953f0185d7ba792f27c14))
* **erc20:** erc20 conversion with no spendable balance ([6d431e9](https://github.com/dymensionxyz/rollapp-evm/commit/6d431e94c1afa4f8340cfd3cfd5554195037fb33))
* **erc20:** fix staking erc20 token ([#491](https://github.com/dymensionxyz/rollapp-evm/issues/491)) ([6eea88c](https://github.com/dymensionxyz/rollapp-evm/commit/6eea88cb4f2812514e4c363cf944fcfa7b2ec73d))
...
* **migration:** add missing evmos params from 2D ([#453](https://github.com/dymensionxyz/rollapp-evm/issues/453)) ([eb5a8a4](https://github.com/dymensionxyz/rollapp-evm/commit/eb5a8a473ecfe9b446c4e5cfaaa126f94b6372bd))
...
* remove pruning cmd added by mistake ([#464](https://github.com/dymensionxyz/rollapp-evm/issues/464)) ([88a0e41](https://github.com/dymensionxyz/rollapp-evm/commit/88a0e41fd0ac98028babe20f7c92e7cdc524374b))
...
* **scripts:** support relay to v50 ([#473](https://github.com/dymensionxyz/rollapp-evm/issues/473)) ([e8c29e4](https://github.com/dymensionxyz/rollapp-evm/commit/e8c29e4e2b8300fc2e8119f34677da0aed938714))
...
* **scripts:** whitelist relayer in ibc ([#474](https://github.com/dymensionxyz/rollapp-evm/issues/474)) ([621b4d8](https://github.com/dymensionxyz/rollapp-evm/commit/621b4d84157cb4044b81d81c2fd78185766a24a4))
* **script:** use empty and mock da config with mock da ([#471](https://github.com/dymensionxyz/rollapp-evm/issues/471)) ([3bbaece](https://github.com/dymensionxyz/rollapp-evm/commit/3bbaece0e8b59b562e44cd9f9e853d324ac96074))
...
* **upgrade:** correct vesting accounts start and end time ([#458](https://github.com/dymensionxyz/rollapp-evm/issues/458)) ([146f029](https://github.com/dymensionxyz/rollapp-evm/commit/146f02957bf699c3d255ec58a4ea67c25b0fe991))
...
* **app:** wired x/dividends ([#459](https://github.com/dymensionxyz/rollapp-evm/issues/459)) ([17bf534](https://github.com/dymensionxyz/rollapp-evm/commit/17bf53480f8b0b566640c9521f380fbcfbad4aaa))
...
* **da:** bump dymint to include BNB support ([#475](https://github.com/dymensionxyz/rollapp-evm/issues/475)) ([e6d5957](https://github.com/dymensionxyz/rollapp-evm/commit/e6d5957d3cf32b6395e221bf201eb9071f337ca5))
...
* **deps:** bump dymint to support new DAs ([#490](https://github.com/dymensionxyz/rollapp-evm/issues/490)) ([4ae2f72](https://github.com/dymensionxyz/rollapp-evm/commit/4ae2f72ad3f0e6fba2f2c53dd02aaf96aa5e110d))
* **deps:** bumped dymint to `v1.5.0-rc01`([#466](https://github.com/dymensionxyz/rollapp-evm/issues/466)) ([002eacd](https://github.com/dymensionxyz/rollapp-evm/commit/002eacd6374e629076ab7add46924d2025841bc7))
...
* **drs:** drs 7 genesis template ([#483](https://github.com/dymensionxyz/rollapp-evm/issues/483)) ([6dc3b50](https://github.com/dymensionxyz/rollapp-evm/commit/6dc3b504128daeadfdc6f2d6ae8d918629460e86))
* **DRS:** DRS 7 with x/dividends ([#468](https://github.com/dymensionxyz/rollapp-evm/issues/468)) ([b093bfb](https://github.com/dymensionxyz/rollapp-evm/commit/b093bfb600543a8154e2f24f56fceab0ea1cb9ad))
...
* **erc20:** support erc20 token for staking and rewards ([#470](https://github.com/dymensionxyz/rollapp-evm/issues/470)) ([41c377b](https://github.com/dymensionxyz/rollapp-evm/commit/41c377b908e421e8f7ae65c6454fc7a0bfbf867a))
...
* **ibc:** adding decimal conversion middleware ([#510](https://github.com/dymensionxyz/rollapp-evm/issues/510)) ([85a29ab](https://github.com/dymensionxyz/rollapp-evm/commit/85a29abd765f71712f89b1131b01da5a95d7a8a2))
...
* **scripts:** added support for sui and aptos ([#467](https://github.com/dymensionxyz/rollapp-evm/issues/467)) ([de3fe4f](https://github.com/dymensionxyz/rollapp-evm/commit/de3fe4fa816beb1fe6c39be6cf6ffdeb1bfccbad))
* **scripts:** added support for walrus ([#469](https://github.com/dymensionxyz/rollapp-evm/issues/469)) ([f6743c6](https://github.com/dymensionxyz/rollapp-evm/commit/f6743c63847a37647fe4af873035bdeafc6c714c))
...
* **version:** drs 6 with free ibc and new da ([#461](https://github.com/dymensionxyz/rollapp-evm/issues/461)) ([4f53e46](https://github.com/dymensionxyz/rollapp-evm/commit/4f53e467b2f9d3ff23ce77b09916ea6451ebf425))
* weave vm da integration ([#451](https://github.com/dymensionxyz/rollapp-evm/issues/451)) ([b6b3747](https://github.com/dymensionxyz/rollapp-evm/commit/b6b3747c954e3bdb52469e83c6521da870c648ee))
