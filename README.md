...
export HUB_KEY_WITH_FUNDS="rol-user" # This key should exist on the keyring-backend test
```
...
BOND_AMOUNT="$(dymd q sequencer params -o json  --node http://3.27.104.226:26657/ | jq -r '.params.min_bond.amount')$(dymd q sequencer params -o json --node http://3.27.104.226:26657/| jq -r '.params.min_bond.denom' )"
